...
ROUTER_SYSTEM_PROMPT = """你是一个智能路由助手，负责判断消息复杂度。
...
HEARTBEAT_SYSTEM_PROMPT = """你是一个群聊助手的心跳检查器。请检查是否有需要关注的事项。
...
class RouterModel:
    ...
    def __init__(self, config: dict):
        ...
        _log.info(
            ...
            f"base_url={config.get('base_url', 'http://localhost:11434/v1')}"
        )
    ...
    async def simple_chat(
        self,
        prompt: str,
        system_prompt: str = HEARTBEAT_SYSTEM_PROMPT,
        max_tokens: int = 500,
    ) -> str:
