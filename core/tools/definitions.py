...
TTS_TOOLS = [
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "【instructions 编写指南】\n"
                "instructions 是控制说话风格的关键，会被自动嵌入到文字开头作为语音设计指令。"
                "建议按以下三层结构编写：\n"
                "- 基底（身份）：性别、年龄、角色定位，例如「中年男性播音员」「可爱少女」\n"
                "- 质感（音色）：音高、音质、特色，例如「声音低沉富有磁性」「清脆甜美」\n"
                "- 表现力（情绪/语速）：情感色彩和节奏，例如「热情欢呼」「温柔地慢慢说」\n"
                "完整示例：'热情洋溢的中年男性播音员，声音较为低沉富有磁性，带着节奏感呼喊'\n"
                "中英文均支持，英文示例：'a young woman, gentle and sweet voice'\n\n"
                "【方言提示】\n"
                "如需方言效果（粤语、四川话、东北话等），text 必须使用地道方言词汇书写，"
                "不能写标准语。例如粤语写「唔該」而非「谢谢」。\n"
                "instructions 中注明方言名即可，如「广东话，中年男性，语气随意」。\n\n"
                "【非语言标签】\n"
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "instructions": {
                        ...
                        "description": (
                            "说话风格/语气/声音描述（可选）。\n"
                            "此描述会自动嵌入到文字开头作为语音设计指令，"
                            "例如传入「可爱少女，温柔地慢慢说」则实际朗读「(可爱少女，温柔地慢慢说)你好」。\n"
                            "按三层结构编写：身份基底 + 音色质感 + 情绪表现力。\n"
                            "示例：\n"
                            "  '热情洋溢的中年男性播音员，声音低沉富有磁性'\n"
                            "  '可爱少女，声音清脆甜美，温柔地慢慢说'\n"
                            "  'a young woman, gentle and sweet voice, speaking cheerfully'\n"
                            "如不需要特殊风格则不传。"
                        ),
                    },
                },
